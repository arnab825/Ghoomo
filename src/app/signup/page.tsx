...
import { UserPlus, Mail, Lock, User, AlertCircle, ArrowRight, Loader2, Eye, EyeOff } from 'lucide-react';
...
function SignupForm() {
  ...
  const { signUp, initializeAuth, isAuthenticated, user, error } = useAuthStore();
